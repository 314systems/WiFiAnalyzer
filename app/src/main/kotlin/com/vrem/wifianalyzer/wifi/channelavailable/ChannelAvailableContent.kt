    ...
    val state = ChannelAvailableState(
        ...
        bands = listOf(
            ...
            BandState(
                title = "5 GHz",
                widths = listOf(
                    WidthState(R.string.wifi_width_20mhz, "36, 40, 44, 48, 52, 56, 60, 64, 100, 104, 108, 112, 116, 120, 124, 128, 132, 136, 140, 144, 149, 153, 157, 161, 165"),
                    WidthState(R.string.wifi_width_40mhz, "38, 46, 54, 62, 102, 110, 118, 126, 134, 142, 151, 159"),
...
@Composable
fun ChannelAvailableContentDarkPreview() {
    val state = ChannelAvailableState(
        countryCode = "US",
        countryName = "United States",
        bands = listOf(
